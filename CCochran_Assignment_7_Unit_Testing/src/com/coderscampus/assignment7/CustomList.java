...
public interface CustomList<T> {
     ...
     *
     * @param item the itme to be added to the <code>CustomList</code>
     * @return <code>true</code> if item was successfullly added, <code>false</code> if the item was not successfully added (note:
     * it should always be able to add an item to the list)
     */
     ...
     * specified index (thus shifting the other items to the right). If the index doesn't yet
     * exist, then you should throw an <code>IndexOutOfBoundsException</code>.
     ...
     * was removed, instead all other itmes to the right will be shuffled to the left.
